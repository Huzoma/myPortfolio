...
export const profileMarkdown = `# Professional Profile: Uzoma

## Contact Details
- **Role**: Lead Frontend Engineer & Full Stack Developer
- **Availability**: Open for hire (contract or full-time roles)
- **Primary Website**: https://github.com/Huzoma
- **LinkedIn**: https://linkedin.com/in/huzoma

## Core Philosophy
I specialize in creating immersive digital experiences and high-performance engineering for the web. I convert complex customer and business requirements into clean, optimized, and responsive code.

## Key Technologies
- **Frameworks**: Next.js (App Router, Server Actions, Dynamic Rendering), React (v19, hooks, component architecture).
- **Styling & Design**: Tailwind CSS (v4), Vanilla CSS, responsive layouts, glassmorphism, micro-animations, Figma.
- **Languages & VCS**: JavaScript (ES6+), Git, HTML5, CSS3.
- **Tools & Ecosystem**: Stripe & Paystack gateways, Local Storage state machines, Canvas API virtualization, Vercel deployments.

## Featured Projects (Ground-Truth Data)

### 1. Synergy Hotels & Suites (SHS)
...
- **Status**: Good / Featured

### 2. Beyond Conversation Pitch
